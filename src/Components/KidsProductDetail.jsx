...
import { kidsProducts } from './Kids'; // Import the product list from Men.jsx

const KidsProductDetail = () => {
  const { id } = useParams();
  const product = kidsProducts.find(p => p.id === parseInt(id));
    ...
    <div className="max-w-4xl mx-auto p-6 mt-10 bg-white rounded-xl shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-between">
          ...
          <Link to="/men" className="mt-6 inline-block text-purple-600 hover:underline">
